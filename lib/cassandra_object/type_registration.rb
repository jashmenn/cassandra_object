if defined?(JRUBY_VERSION)
  ...
  CassandraObject::Base.register_attribute_type(:date, Date, CassandraObject::ToJavaType, S::DateSerializer.get)
  CassandraObject::Base.register_attribute_type(:time, Time, CassandraObject::ToJavaType, S::DateSerializer.get)
  CassandraObject::Base.register_attribute_type(:time_with_zone, ActiveSupport::TimeWithZone, CassandraObject::ToJavaType, S::DateSerializer.get)
